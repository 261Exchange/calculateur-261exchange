...
if is_crypto:
    ...
    if operation == "Dépôt" and service in ["Skrill", "Neteller"]:
        frais = None  # calculé dynamiquement
...
if sens == "Ariary ➜ USD/Crypto":
    ...
    if is_crypto:
        ...
        st.write(f"💸 Frais appliqués : 0 {cryptos[service]['symbol']}")
        ...
        montant_ariary = montant_usd * taux
        st.success(f"💵 Montant à recevoir : {montant_ariary:.0f} Ar")
        st.write(f"💸 Frais appliqués : 0 USD")
